...
from vista.model.equi.vista_obs_encoder import VISTAObsEncoder
from vista.model.equi.equi_conditional_unet1d_c8 import EquiDiffusionUNet
from vista.model.vision.rot_randomizer import (
    RotRandomizer,
...
class VISTAPolicy(BaseImagePolicy):
    def __init__(
        ...
        **kwargs,
        ...
        if "robot0_tactile_right_image" in obs_shape_meta:
            raise ValueError("VISTA SO2 supports only single tactile input: robot0_tactile_left_image")
    ...
    def predict_action(
        ...
        obs_dict["robot0_eef_pos"] = obs_dict["robot0_eef_pos"].clone()
