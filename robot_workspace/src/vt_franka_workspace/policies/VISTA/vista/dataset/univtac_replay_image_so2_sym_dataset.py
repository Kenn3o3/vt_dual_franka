...
from vista.common.normalize_util import (
    abs_action_only_so2_symmetric_normalizer_from_stat,
    array_to_stats,
...
from vista.dataset.univtac_replay_image_dataset import (
...
class UniVTACReplayImageSO2SymDataset(UniVTACReplayImageDataset):
    def __init__(
        self,
        shape_meta: dict,
        dataset_root: str,
    ...
    def get_normalizer(self, **kwargs) -> LinearNormalizer:
        ...
        if self.normalization_mode == "off":
            ...
            action_normalizer = abs_action_only_so2_symmetric_normalizer_from_stat(
                stat
            )
