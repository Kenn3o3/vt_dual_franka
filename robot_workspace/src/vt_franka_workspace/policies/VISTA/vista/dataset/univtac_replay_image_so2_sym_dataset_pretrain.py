...
class UniVTACReplayImageSO2SymPretrainDataset(UniVTACReplayImageDataset):
    def __init__(
        self,
        shape_meta: dict,
        dataset_root: str,
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            seed=seed,
            val_ratio=val_ratio,
            image_identity_normalizer=True,
            cache_dir=cache_dir,
            **kwargs,
        )
    ...
    def get_normalizer(self, **kwargs) -> LinearNormalizer:
        ...
        for key in self.rgb_keys:
            ...
            elif key.startswith("robot0_tactile_"):
                normalizer[key] = get_image_range_normalizer()
            else:
                normalizer[key] = get_image_identity_normalizer()

        for key in self.prepared_tactile_keys:
