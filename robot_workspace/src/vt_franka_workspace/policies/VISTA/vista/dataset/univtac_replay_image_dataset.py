...
from vista.common.normalize_util import (
...
from vista.common.pytorch_util import dict_apply
from vista.common.replay_buffer import ReplayBuffer
from vista.common.sampler import SequenceSampler, get_val_mask
from vista.common.univtac_util import (
    canonicalize_gripper_qpos,
    compute_ws_center,
    gripper_scalar_from_qpos,
)
from vista.dataset.base_dataset import BaseImageDataset
from vista.model.common.normalizer import LinearNormalizer, SingleFieldLinearNormalizer
...
def _decode_jpeg_sequence(
    ...
    for i in range(n_frames):
        ...
        # NOTE: historical VISTA preprocessing directly resized decoded wrist frames
        ...
        for key, attr in obs_shape_meta.items():
            ...
            if obs_type in {"rgb", "tactile_rgb"}:
                ...
                raise ValueError(
                    ...
                    "VISTA now supports only tactile RGB with markers via "
                    "'robot0_tactile_left_image' type=tactile_rgb."
                )
            else:
