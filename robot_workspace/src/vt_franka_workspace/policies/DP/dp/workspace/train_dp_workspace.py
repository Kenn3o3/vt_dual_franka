...
from dp.common.checkpoint_util import TopKCheckpointManager
from dp.common.json_logger import JsonLogger
from dp.common.pytorch_util import dict_apply, optimizer_to
from dp.model.diffusion.ema_model import EMAModel
from dp.model.common.lr_scheduler import get_scheduler
...
class TrainDPWorkspace(BaseWorkspace):
...
def main(cfg):
    workspace = TrainDPWorkspace(cfg)
    workspace.run()
