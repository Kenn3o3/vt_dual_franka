...
class VendorACTCheckpointBackend:
    ...
    def _ensure_loaded(self) -> None:
        ...
        if self.model_spec.name == "vital_act":
            from vt_franka_workspace.policies.ViTAL.clip_pretraining import modified_resnet18
            from vt_franka_workspace.policies.ViTAL.policy import ACT
            ...
            from vt_franka_workspace.policies.ACT.act_policy import ACT
