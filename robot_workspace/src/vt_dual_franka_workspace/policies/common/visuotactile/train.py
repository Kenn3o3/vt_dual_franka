...
POLICIES_ROOT = WORKSPACE_SRC_ROOT / "vt_dual_franka_workspace" / "policies"
...
def _univtac_act_train_command(
    ...
    *,
    ...
    return [
        sys.executable,
        "-m",
        "vt_dual_franka_workspace.policies.ACT.imitate_episodes",
        "--ckpt_dir",
        str(checkpoint_dir),
        "--task_name",
        config.task_name,
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train a VT Dual Franka visuotactile policy")
