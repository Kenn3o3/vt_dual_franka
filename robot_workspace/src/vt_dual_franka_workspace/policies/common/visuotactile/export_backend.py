...
def _require_h5py():
    try:
        ...
        raise RuntimeError(
            "h5py is required to export VT Dual Franka prepared datasets to vendor HDF5 backend format. "
...
def _require_cv2():
    try:
        ...
        raise RuntimeError("OpenCV is required to export VT Dual Franka backend HDF5 image payloads.") from exc
    return cv2
