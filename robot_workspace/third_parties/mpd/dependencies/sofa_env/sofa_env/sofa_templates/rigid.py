...
class ArticulatedInstrument:
    ...
    def __init__(
        ...
        self.joint_mechanical_object = self.joint.addObject(
            ...
            reset_position=np.tile(pose, number_of_rigid_objects),
        )
