...
set_target_properties(Sofa.GUI PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libSofa.GUI.so.23.12.01"
  IMPORTED_SONAME_MINSIZEREL "libSofa.GUI.so.23.12.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS Sofa.GUI )
list(APPEND _IMPORT_CHECK_FILES_FOR_Sofa.GUI "${_IMPORT_PREFIX}/lib/libSofa.GUI.so.23.12.01" )
...
set_target_properties(runSofa PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/runSofa-23.12.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS runSofa )
list(APPEND _IMPORT_CHECK_FILES_FOR_runSofa "${_IMPORT_PREFIX}/bin/runSofa-23.12.01" )
...
set_target_properties(runSofaGLFW PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/runSofaGLFW-23.12.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS runSofaGLFW )
list(APPEND _IMPORT_CHECK_FILES_FOR_runSofaGLFW "${_IMPORT_PREFIX}/bin/runSofaGLFW-23.12.01" )
