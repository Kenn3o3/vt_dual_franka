...
#ifdef SOFA_BUILD_SOFA_HELPER
#define SOFA_WRITEACCESSOR_RESIZE_DISABLED()
#else
#define SOFA_WRITEACCESSOR_RESIZE_DISABLED() \
...
#ifdef SOFA_BUILD_SOFA_HELPER
#define SOFA_MESHTOPOLOGYLOADER_LOADMESHFUNCTION_DEPRECATED()
#else
#define SOFA_MESHTOPOLOGYLOADER_LOADMESHFUNCTION_DEPRECATED() \
...
#ifdef SOFA_BUILD_SOFA_HELPER
#define SOFA_LCPCALC_AFFICHELCP_DEPRECATED()
#else
#define SOFA_LCPCALC_AFFICHELCP_DEPRECATED() \
SOFA_ATTRIBUTE_DEPRECATED( \
...
#ifdef SOFA_BUILD_SOFA_HELPER
#define SOFA_LCPCALC_AFFICHESYST_DEPRECATED()
#else
#define SOFA_LCPCALC_AFFICHESYST_DEPRECATED() \
SOFA_ATTRIBUTE_DEPRECATED( \
...
#ifdef SOFA_BUILD_SOFA_HELPER
#define SOFA_LCPCALC_RESOUDRELCP_DEPRECATED()
#else
#define SOFA_LCPCALC_RESOUDRELCP_DEPRECATED() \
SOFA_ATTRIBUTE_DEPRECATED( \
