...
from movement_primitive_diffusion.utils.setup_helper import setup_agent_and_workspace, parse_swanlab_to_hydra_config
...
def main(cfg: DictConfig) -> None:
    # Load swanlab config
    swanlab_config = OmegaConf.load(cfg.config)
