...
class ProDMPHandler(TrajectoryHandler):
    ...
    def decode(
        ...
        initial_position = (
            ...
            else torch.zeros(batch_size, self.prodmp_config.num_dof, device=params.device)
        )
        initial_velocity = (
            initial_velocity
        ...
        initial_position = initial_position.to(params.device)
        initial_velocity = initial_velocity.to(params.device)
