...
class ACTPolicyWrapper(BaseImagePolicy):
    def __init__(
        ...
        self.n_obs_steps = 1
        self.n_action_steps = self.num_queries
    ...
    def set_ws_center(self, ws_center: torch.Tensor):
        # ISP-ACT predicts the same absolute 10D action representation as the
        # UniVTAC image dataset and does not use workspace recentering.
        return None
