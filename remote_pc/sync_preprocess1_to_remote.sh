...
LOCAL_PATH="${REPO_ROOT}/robot_workspace/data/preprocess1/${TASK_NAME}/${PROFILE_NAME}"
REMOTE_PATH="${REMOTE_ROOT}/robot_workspace/data/preprocess1/${TASK_NAME}/${PROFILE_NAME}"
...
rsync "${RSYNC_ARGS[@]}" -e "ssh ${SSH_ARGS[*]}" "${LOCAL_PATH}/" "${REMOTE}:${REMOTE_PATH}/"
